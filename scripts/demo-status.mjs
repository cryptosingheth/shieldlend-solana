...
console.log(`
  ...
  ✗ MagicBlock Private Payments private transfer end-to-end live (deposit/top-up do not expose usable private balance; funded path reaches Token Program 0x1 InsufficientFunds)
