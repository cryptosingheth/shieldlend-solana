...
- Do NOT say MagicBlock Private Payments private transfer is live end-to-end. State: "Public API auth/builders and wSOL deposit/withdraw are live; deposit and the submitted base-to-ephemeral top-up do not expose usable private wSOL, so the intended ephemeral/router private-transfer path is still blocked."
